                        ...
                        <div class="row">
                            ...
                            <div class="col text-right">
                                <div class="form-group pb-0 mb-0 row">
                                    <label for="colFormLabelSm" class="col-sm-5 col-form-label col-form-label-sm">Suche Stunden von Datum</label>
                                    <select class="col-sm-3 form-control form-control-sm">
                                        <option disabled selected value> Datum auswählen </option>
                                        <option>21.07.2019</option>
                                        <option>20.07.2019</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="form-row col-lg-4 col-md-6 col-sm-12">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input name="std_gesamt" type="text" name="gesamt" id="gesamt" class="form-control" disabled>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-2 col-sm-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="auftragsnummer">
                                ...
                                <div class="col-lg-3 col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <label for="auftrags_id">Tätigkeit</label>
                                        <select class="form-control" id="auftragsnummer">
                                            <option disabled selected value> Auftrag auswählen </option>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-8 col-md-">
                                <div class="form-group row">
                                    <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">Stundensumme</label>
                                    <div class="col-sm-3">
